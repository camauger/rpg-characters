...
#         self.ethnicity_name = character.ethnicity_name
#         self.actor = character.description
#         self.portrait_setting = character.background_setting
#         self.ethnicity_keywords = character.ethnicity_keywords
...
# #         prompt = "{portrait} in the style of {artist} mixed with {style} | {genre} | {actor} | {behavior} | {full_name} is wearing {clothing} clothing | {tones} tones | {camera} | {posing} | {accessories} | {lighting} | {portrait_setting} | ".format_map(
# #             prompt_properties)

# #         prompt = f"{prompt} {self.character.ethnicity_keywords}"

# #         # This is the prompt for midjourney
# #         prompt_midjourney = f"{prompt} , RPG, D&D. --s 1000 --ar 90:160"
...
# #         picture_name = self.character.full_name.replace(" ", "_").lower()
